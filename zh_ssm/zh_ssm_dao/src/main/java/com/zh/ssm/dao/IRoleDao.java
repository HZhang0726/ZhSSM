...
import com.zh.ssm.domain.Permission;
...
public interface IRoleDao {
    ...
    @Results({
            ...
            @Result(property = "permissions",column = "id",javaType = java.util.List.class,many = @Many(select = "com.zh.ssm.dao.IPermissionDao.findPermissionByRoleId"))
